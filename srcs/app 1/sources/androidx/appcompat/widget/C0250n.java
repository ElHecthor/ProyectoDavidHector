...
public class C0250n extends MultiAutoCompleteTextView implements C3378u {

    /* renamed from: h */
    private static final int[] f1087h = {16843126};

    /* renamed from: f */
    private final C0211e f1088f;

    /* renamed from: g */
    private final C0280v f1089g;

    public C0250n(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C3093a.autoCompleteTextViewStyle);
    }

    public C0250n(Context context, AttributeSet attributeSet, int i) {
        super(C0258q0.m1264b(context), attributeSet, i);
        C0275t0 a = C0275t0.m1311a(getContext(), attributeSet, f1087h, i, 0);
        if (a.mo1751g(0)) {
    ...
    public void drawableStateChanged() {
        ...
        C0211e eVar = this.f1088f;
        if (eVar != null) {
            eVar.mo1321a();
        }
        C0280v vVar = this.f1089g;
        if (vVar != null) {
            vVar.mo1793a();
        }
    }
