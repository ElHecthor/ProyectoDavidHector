...
public class AlertDialogLayout extends C0212e0 {
    ...
    /* renamed from: a */
    private void m853a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m854c(View view) {
        int q = C3379v.m13830q(view);
        if (q > 0) {
            return q;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m854c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: c */
    private void m855c(int i, int i2) {
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0213a aVar = (C0213a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: d */
    private boolean m856d(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C3098f.topPanel) {
                    view = childAt;
                } else if (id == C3098f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C3098f.contentPanel && id != C3098f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.e0$a r15 = (androidx.appcompat.widget.C0212e0.C0213a) r15
            int r2 = r15.f953b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = p071f.p097h.p108m.C3379v.m13829p(r17)
            int r2 = p071f.p097h.p108m.C3339d.m13606a(r2, r3)
            r2 = r2 & 7
            r3 = 1
