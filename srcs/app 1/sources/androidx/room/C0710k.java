...
public class C0710k {
    /* renamed from: a */
    public static <T extends C0711l> C0712a<T> m3950a(Context context, Class<T> cls) {
        return new C0712a<>(context, cls, null);
    }

    /* renamed from: a */
    public static <T extends C0711l> C0712a<T> m3951a(Context context, Class<T> cls, String str) {
        if (str != null && str.trim().length() != 0) {
            return new C0712a<>(context, cls, str);
        }
        throw new IllegalArgumentException("Cannot build a database with null or empty name. If you are trying to create an in memory database, use Room.inMemoryDatabaseBuilder");
    }

    /* renamed from: a */
    static <T, C> T m3952a(Class<C> cls, String str) {
        String str2;
