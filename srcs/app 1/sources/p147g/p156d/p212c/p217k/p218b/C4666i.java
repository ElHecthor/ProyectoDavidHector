...
public final class C4666i {
    ...
    /* renamed from: a */
    private static String m18831a(CharSequence charSequence, int i) {
        return m18832a(charSequence, 0, charSequence.length(), i);
    }

    /* renamed from: a */
    private static String m18832a(CharSequence charSequence, int i, int i2, int i3) {
        int i4 = 0;
        while (true) {
            int[] iArr = f12242a;
            if (i4 >= iArr.length) {
    ...
    /* renamed from: a */
    public static String m18833a(String str, C4668k kVar) {
        if (str.length() == kVar.mo13637a()) {
            StringBuilder sb = new StringBuilder(kVar.mo13637a() + kVar.mo13638b());
            sb.append(str);
            int c = kVar.mo13615c();
            if (c == 1) {
                sb.append(m18831a((CharSequence) str, kVar.mo13638b()));
            } else {
                ...
                while (i < c) {
                    int i2 = i + 1;
                    iArr[i] = kVar.mo13614a(i2);
                    iArr2[i] = kVar.mo13639b(i2);
                    iArr3[i] = 0;
                    if (i > 0) {
                ...
                for (int i3 = 0; i3 < c; i3++) {
                    ...
                    for (int i4 = i3; i4 < kVar.mo13637a(); i4 += c) {
                        sb2.append(str.charAt(i4));
                    }
                    String a = m18831a((CharSequence) sb2.toString(), iArr2[i3]);
                    int i5 = i3;
                    int i6 = 0;
                    while (i5 < iArr2[i3] * c) {
                        int i7 = i6 + 1;
                        sb.setCharAt(kVar.mo13637a() + i5, a.charAt(i6));
                        i5 += c;
                        i6 = i7;
                    }
                }
