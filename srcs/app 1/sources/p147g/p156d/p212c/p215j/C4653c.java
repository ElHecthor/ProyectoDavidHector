...
public enum C4653c {
    ...
    /* renamed from: I */
    private static final Map<Integer, C4653c> f12189I = null;

    /* renamed from: J */
    private static final Map<String, C4653c> f12190J = null;
    ...
    static {
        ...
        f12189I = new HashMap();
        f12190J = new HashMap();
        for (C4653c cVar : values()) {
            for (int valueOf : cVar.f12211f) {
                f12189I.put(Integer.valueOf(valueOf), cVar);
            }
            f12190J.put(cVar.name(), cVar);
            for (String put : cVar.f12212g) {
                f12190J.put(put, cVar);
            }
        }
    }

    private C4653c(int i) {
        this(r3, r4, new int[]{i}, new String[0]);
    }

    private C4653c(int i, String... strArr) {
        this.f12211f = new int[]{i};
        this.f12212g = strArr;
    }

    private C4653c(int[] iArr, String... strArr) {
        this.f12211f = iArr;
        this.f12212g = strArr;
    }

    /* renamed from: a */
    public static C4653c m18758a(String str) {
        return (C4653c) f12190J.get(str);
    }
