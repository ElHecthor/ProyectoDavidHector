package com.bumptech.glide.p023p;
...
public final class C1257d {
    ...
    public C1257d(Context context) {
        this.f4165a = context;
    }

    /* renamed from: a */
    private static C1255b m5887a(String str) {
        try {
            Class cls = Class.forName(str);
            try {
                Object newInstance = cls.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                if (newInstance instanceof C1255b) {
                    return (C1255b) newInstance;
                }
    ...
    /* renamed from: a */
    private static void m5888a(Class<?> cls, Exception exc) {
        StringBuilder sb = new StringBuilder();
    ...
    public List<C1255b> mo5225a() {
        ...
        try {
            ApplicationInfo applicationInfo = this.f4165a.getPackageManager().getApplicationInfo(this.f4165a.getPackageName(), 128);
