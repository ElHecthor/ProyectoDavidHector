...
public class C1147j extends C1143f {

    /* renamed from: b */
    private static final byte[] f3919b = "com.bumptech.glide.load.resource.bitmap.CenterInside".getBytes(C0869g.f3390a);

    /* access modifiers changed from: protected */
    /* renamed from: a */
    public Bitmap mo5028a(C0921e eVar, Bitmap bitmap, int i, int i2) {
        return C1125b0.m5386b(eVar, bitmap, i, i2);
    }
