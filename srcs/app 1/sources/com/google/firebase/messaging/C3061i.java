...
public final class C3061i {
    ...
    /* renamed from: a */
    private static final AtomicInteger f8713a = new AtomicInteger((int) SystemClock.elapsedRealtime());

    /* renamed from: a */
    private static int m12449a(PackageManager packageManager, Resources resources, String str, String str2, Bundle bundle) {
        String str3 = "FirebaseMessaging";
        if (!TextUtils.isEmpty(str2)) {
            int identifier = resources.getIdentifier(str2, "drawable", str);
            if (identifier != 0 && m12454a(resources, identifier)) {
                return identifier;
            }
            int identifier2 = resources.getIdentifier(str2, "mipmap", str);
            if (identifier2 != 0 && m12454a(resources, identifier2)) {
                return identifier2;
            }
    ...
    /* renamed from: a */
    private static PendingIntent m12450a(Context context, Intent intent) {
        return PendingIntent.getBroadcast(context, f8713a.incrementAndGet(), new Intent("com.google.firebase.MESSAGING_EVENT").setComponent(new ComponentName(context, "com.google.firebase.iid.FirebaseInstanceIdReceiver")).putExtra("wrapped_intent", intent), 1073741824);
    }

    /* renamed from: a */
    private static Bundle m12451a(PackageManager packageManager, String str) {
        try {
    ...
    static com.google.firebase.messaging.C3055d m12452a(android.content.Context r9, com.google.firebase.messaging.C3077y r10) {
        /*
            android.content.pm.PackageManager r0 = r9.getPackageManager()
            java.lang.String r1 = r9.getPackageName()
            android.os.Bundle r0 = m12451a(r0, r1)
            java.lang.String r1 = r9.getPackageName()
            java.lang.String r2 = "gcm.n.android_channel_id"
            java.lang.String r2 = r10.mo9856a(r2)
            java.lang.String r2 = m12455b(r9, r2, r0)
            android.content.res.Resources r3 = r9.getResources()
            android.content.pm.PackageManager r4 = r9.getPackageManager()
            androidx.core.app.i$e r5 = new androidx.core.app.i$e
            r5.<init>(r9, r2)
            java.lang.String r2 = "gcm.n.title"
            java.lang.String r2 = r10.mo9855a(r3, r1, r2)
        ...
        L_0x0050:
            ...
            java.lang.String r2 = r10.mo9856a(r2)
            int r2 = m12449a(r4, r3, r1, r2, r0)
            r5.mo2215e(r2)
            java.lang.String r2 = r10.mo9857b()
            boolean r6 = android.text.TextUtils.isEmpty(r2)
            r7 = 2
            r8 = 0
        ...
        L_0x00b5:
            ...
            goto L_0x00f1
        L_0x00d1:
            android.net.Uri r2 = r10.mo9854a()
        ...
        L_0x0139:
            ...
            r1.<init>(r2)
            android.os.Bundle r2 = r10.mo9865f()
            android.content.Intent r1 = r1.putExtras(r2)
            android.app.PendingIntent r1 = m12450a(r9, r1)
        L_0x014c:
            if (r1 == 0) goto L_0x0151
            r5.mo2208b(r1)
        L_0x0151:
            java.lang.String r1 = "gcm.n.color"
            java.lang.String r1 = r10.mo9856a(r1)
            java.lang.Integer r9 = m12453a(r9, r1, r0)
            if (r9 == 0) goto L_0x0164
            int r9 = r9.intValue()
            r5.mo2194a(r9)
        L_0x0164:
            java.lang.String r9 = "gcm.n.sticky"
            boolean r9 = r10.mo9858b(r9)
            r0 = 1
            r9 = r9 ^ r0
            r5.mo2204a(r9)
            ...
            java.lang.String r9 = r10.mo9856a(r9)
            if (r9 == 0) goto L_0x0183
            r5.mo2212c(r9)
        L_0x0183:
            java.lang.String r9 = "gcm.n.notification_priority"
            java.lang.Integer r9 = r10.mo9859c(r9)
        ...
        L_0x0256:
            ...
            java.lang.Long r9 = r10.mo9861d(r9)
        ...
        L_0x029f:
            ...
            java.lang.String r10 = r10.mo9856a(r0)
        ...
        L_0x02c8:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.messaging.C3061i.m12452a(android.content.Context, com.google.firebase.messaging.y):com.google.firebase.messaging.d");
    }

    /* renamed from: a */
    private static Integer m12453a(Context context, String str, Bundle bundle) {
        ...
        if (i != 0) {
            try {
                return Integer.valueOf(C3236a.m13263a(context, i));
    ...
    @TargetApi(26)
    /* renamed from: a */
    private static boolean m12454a(Resources resources, int i) {
    ...
    @TargetApi(26)
    /* renamed from: b */
    private static String m12455b(Context context, String str, Bundle bundle) {
        String str2;
        if (VERSION.SDK_INT < 26) {
            return null;
        }
        try {
            ...
            Log.w(str3, str2);
            String str4 = "fcm_fallback_notification_channel";
            if (notificationManager.getNotificationChannel(str4) == null) {
                notificationManager.createNotificationChannel(new NotificationChannel(str4, context.getString(context.getResources().getIdentifier("fcm_fallback_notification_channel_label", "string", context.getPackageName())), 3));
            }
            return str4;
