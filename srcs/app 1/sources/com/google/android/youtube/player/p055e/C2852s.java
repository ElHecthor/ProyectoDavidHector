...
/* renamed from: com.google.android.youtube.player.e.s */
public final class C2852s {
    /* renamed from: a */
    public static Map<String, String> m11843a(Locale locale) {
        ...
        m11844a(hashMap, locale.getLanguage());
        ...
        sb.append("_");
        sb.append(valueOf2);
        m11844a(hashMap, sb.toString());
        return hashMap;
    }

    /* renamed from: a */
    private static void m11844a(Map<String, String> map, String str) {
        ...
        if ("af".equals(str)) {
            ...
            map.put(str8, str15);
            String str16 = "የYouTube መተግበሪያውን ያንቁ";
            map.put(str7, str16);
            map.put(str6, "የYouTube መተግበሪያውን እስካላነቁ ድረስ ይህ መተግበሪያ አይሰራም።");
            map.put(str5, str16);
            String str17 = "የYouTube መተግበሪያውን ያዘምኑ";
            map.put(str4, str17);
            ...
            String str23 = "Actualizar YouTube";
            if ("es_US".equals(str)) {
