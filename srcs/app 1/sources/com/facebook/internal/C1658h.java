...
public class C1658h {
    ...
    /* renamed from: a */
    private static final HashSet<String> f5064a = m7218a();

    /* renamed from: a */
    private static HashSet<String> m7218a() {
    ...
    /* renamed from: a */
    public static boolean m7219a(Context context, String str) {
        ...
        try {
            ...
            if (signatureArr != null && signatureArr.length > 0) {
                for (Signature byteArray : signatureArr) {
                    if (!f5064a.contains(C1698v.m7364a(byteArray.toByteArray()))) {
                        return false;
                    }
                }
                return true;
