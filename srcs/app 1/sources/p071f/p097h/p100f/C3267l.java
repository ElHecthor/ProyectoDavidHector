...
/* renamed from: f.h.f.l */
public class C3267l extends C3268m {
    /* renamed from: a */
    ...
    public android.graphics.Typeface mo10605a(android.content.Context r11, android.os.CancellationSignal r12, p071f.p097h.p105j.C3283b.C3289f[] r13, int r14) {
        ...
        L_0x0009:
            ...
            r6 = r13[r3]
            android.net.Uri r7 = r6.mo10645c()     // Catch:{ IOException -> 0x0062 }
        ...
        L_0x0020:
            ...
            int r9 = r6.mo10646d()     // Catch:{ all -> 0x0054 }
            android.graphics.fonts.Font$Builder r8 = r8.setWeight(r9)     // Catch:{ all -> 0x0054 }
            boolean r9 = r6.mo10647e()     // Catch:{ all -> 0x0054 }
        ...
        L_0x0035:
            ...
            int r6 = r6.mo10644b()     // Catch:{ all -> 0x0054 }
        ...
        L_0x0078:
            ...
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: p071f.p097h.p100f.C3267l.mo10605a(android.content.Context, android.os.CancellationSignal, f.h.j.b$f[], int):android.graphics.Typeface");
    }
    ...
    public Typeface mo10606a(Context context, C3242b bVar, Resources resources, int i) {
        ...
        while (true) {
            ...
            C3243c cVar = a[i3];
            try {
                Font.Builder weight = new Font.Builder(resources, cVar.mo10592b()).setWeight(cVar.mo10595e());
                if (!cVar.mo10596f()) {
                    i4 = 0;
                }
                Font build = weight.setSlant(i4).setTtcIndex(cVar.mo10593c()).setFontVariationSettings(cVar.mo10594d()).build();
                if (builder == null) {
