...
class C3263h extends C3268m {

    /* renamed from: b */
    private static Class<?> f9383b = null;

    /* renamed from: c */
    private static Constructor<?> f9384c = null;

    /* renamed from: d */
    private static Method f9385d = null;

    /* renamed from: e */
    private static Method f9386e = null;
    ...
    /* renamed from: a */
    private static Typeface mo10608a(Object obj) {
        mo10609a();
        try {
            Object newInstance = Array.newInstance(f9383b, 1);
            Array.set(newInstance, 0, obj);
            return (Typeface) f9386e.invoke(null, new Object[]{newInstance});
    ...
    /* renamed from: a */
    private File m13372a(ParcelFileDescriptor parcelFileDescriptor) {
        try {
    ...
    /* renamed from: a */
    private static boolean m13374a(Object obj, String str, int i, boolean z) {
        mo10609a();
        try {
            return ((Boolean) f9385d.invoke(obj, new Object[]{str, Integer.valueOf(i), Boolean.valueOf(z)})).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    /* renamed from: b */
    private static Object m13375b() {
        mo10609a();
        try {
            return f9384c.newInstance(new Object[0]);
    ...
    public android.graphics.Typeface mo10605a(android.content.Context r4, android.os.CancellationSignal r5, p071f.p097h.p105j.C3283b.C3289f[] r6, int r7) {
        /*
            r3 = this;
            int r0 = r6.length
            r1 = 0
            ...
            return r1
        L_0x0006:
            f.h.j.b$f r6 = r3.mo10617a(r6, r7)
            android.content.ContentResolver r7 = r4.getContentResolver()
            android.net.Uri r6 = r6.mo10645c()     // Catch:{ IOException -> 0x0067 }
        ...
        L_0x001f:
            return r1
        L_0x0020:
            java.io.File r6 = r3.m13372a(r5)     // Catch:{ all -> 0x0059 }
        ...
        L_0x0037:
            ...
            android.graphics.Typeface r4 = super.mo10616a(r4, r6)     // Catch:{ all -> 0x004d }
        ...
        L_0x0067:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p071f.p097h.p100f.C3263h.mo10605a(android.content.Context, android.os.CancellationSignal, f.h.j.b$f[], int):android.graphics.Typeface");
    }

    /* renamed from: a */
    public Typeface mo10606a(Context context, C3242b bVar, Resources resources, int i) {
        Object b = m13375b();
        C3243c[] a = bVar.mo10590a();
        int length = a.length;
        int i2 = 0;
        while (i2 < length) {
            C3243c cVar = a[i2];
            File a2 = C3272n.m13428a(context);
            if (a2 == null) {
                return null;
            }
            try {
                if (!C3272n.m13433a(a2, resources, cVar.mo10592b())) {
                    a2.delete();
                    return null;
                } else if (!m13374a(b, a2.getPath(), cVar.mo10595e(), cVar.mo10596f())) {
                    return null;
                } else {
                    i2++;
                }
