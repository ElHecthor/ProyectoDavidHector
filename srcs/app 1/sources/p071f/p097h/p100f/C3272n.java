...
public class C3272n {
    ...
    /* renamed from: a */
    public static ByteBuffer m13429a(Context context, Resources resources, int i) {
        File a = m13428a(context);
        if (a == null) {
            return null;
        }
        try {
            if (!m13433a(a, resources, i)) {
                return null;
            }
            ByteBuffer a2 = m13431a(a);
            a.delete();
            return a2;
        } finally {
            a.delete();
    ...
    public static java.nio.ByteBuffer m13430a(android.content.Context r7, android.os.CancellationSignal r8, android.net.Uri r9) {
        /*
        ...
        L_0x004f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p071f.p097h.p100f.C3272n.m13430a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.nio.ByteBuffer m13431a(java.io.File r7) {
        /*
        ...
        L_0x0025:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p071f.p097h.p100f.C3272n.m13431a(java.io.File):java.nio.ByteBuffer");
    }

    /* renamed from: a */
    public static void m13432a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
    ...
    /* renamed from: a */
    public static boolean m13433a(File file, Resources resources, int i) {
        InputStream inputStream;
        try {
            inputStream = resources.openRawResource(i);
            try {
                boolean a = m13434a(file, inputStream);
                m13432a((Closeable) inputStream);
                return a;
            } catch (Throwable th) {
                th = th;
                m13432a((Closeable) inputStream);
    ...
    /* renamed from: a */
    public static boolean m13434a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        m13432a((Closeable) fileOutputStream2);
                ...
                try {
                    ...
                    m13432a((Closeable) fileOutputStream);
                    StrictMode.setThreadPolicy(allowThreadDiskWrites);
                    return false;
                } catch (Throwable th) {
                    th = th;
