...
/* renamed from: f.w.a.a.d */
public class C3641d {
    /* renamed from: a */
    public static Interpolator m14801a(Context context, int i) {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m14802a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
    ...
    /* renamed from: a */
    private static Interpolator m14802a(Context context, Resources resources, Theme theme, XmlPullParser xmlPullParser) {
        Interpolator gVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            gVar = new C3645g(context, asAttributeSet, xmlPullParser);
                        } else {
                            StringBuilder sb = new StringBuilder();
